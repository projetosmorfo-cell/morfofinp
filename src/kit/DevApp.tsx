...
function AbaParametros({ podeVerFuncN0, subInicial }: { podeVerFuncN0: (k: string) => boolean; subInicial?: SubParametros }) {
  ...
  if (sub === 'pacotesIcones') return <TelaGrupoN0 titulo="Pacotes de ícones" subtitulo="As três propostas e qual delas cliente novo recebe" onVoltarSub={voltar} render={(n) => <PacotesIconesN0 notify={n} />} />
